...
const buttonVariants = cva(
    "inline-flex items-center justify-center rounded-[14px] whitespace-nowrap text-sm font-medium transition-colors outline-none disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                primaryRed: "bg-[#EF4444] border-2 border-b-4 border-[#DC2626] active:border-b-2 hover:bg-[#FF5252] hover:border-[#FF2F2F]",
